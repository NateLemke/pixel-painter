...
export default function ColourOption({colour, index, selectedIndex, setSelected}) {
    ...
    return(
        <div className={`flex justify-center items-center aspect-square w-auto  hover:bg-zinc-600 
